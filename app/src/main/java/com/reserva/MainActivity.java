...
public class MainActivity extends Activity implements OnSeekBarChangeListener,
	...
	public void reserva(View v) {
		celebras = (EditText) findViewById(R.id.celebras);
		nombreD = (EditText) findViewById(R.id.nombreD);
		...
		datos.putString("celebras", celebras.getText().toString());
		datos.putString("nombreD", nombreD.getText().toString());
		datos.putString("nombreR", nombreR.getText().toString());
