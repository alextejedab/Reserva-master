...
public class Actividad2 extends Activity {
	...
	String nombre = "", fecha = "", hora = "", nombreD = "", nombreR = "", celebras = "";
	int personas = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		nombreD = recibe.getString("nombreD");
		nombreR = recibe.getString("nombreR");
		celebras = recibe.getString("celebras");

		muestraDatos.setText("Reservacion a nombre de:\n" + nombre + "\n" + personas
				+ " personas\nFecha: " + fecha + "\nHora: " + hora + "\n" + "nombre Restaurante:\n" + nombreR + "nombre Dueño:\n" + nombreD + "¿Que celebras?:\n" + celebras);
